...
(function (global, factory) {
    ...
    */
    ...
    function scrollToNewActivePanel() {
      ...
      if (!activeSection && state.sections.length && !getState().isBeyondFullpage) {
        var onResponsiveTransformation = usingExtension('responsiveSlides') && extensionCall('responsiveSlides', 'areSlidesSections');

        if (onResponsiveTransformation) {
          setState({
            activeSection: state.panels.filter(function (panel) {
              return panel.item === $(SECTION_SEL);
            })[0]
          });
        } else {
    ...
    */
    ...
    function getSectionByAnchor(sectionAnchor) {
      if (usingExtension('responsiveSlides') && extensionCall('responsiveSlides', 'areSlidesSections')) {
        return getPanelByElement(state.sections, extensionCall('responsiveSlides', 'getSectionByAnchor', sectionAnchor));
      }
    ...
    */
    ...
    function reBuild(resizing) {
      ...
      var sectionIndex = extensionCall('responsiveSlides', 'getActiveIndex') || getState().activeSection.index();
    ...
    */
    ...
    function scrollHandler(e) {
      ...
      if ((!getOptions().autoScrolling || getOptions().scrollBar || usingExtension('dragAndMove')) && !isDragging()) {
        ...
        var responsivePanels = extensionCall('responsiveSlides', 'areSlidesSections') ? extensionCall('responsiveSlides', 'panels') : null;
        var sections = responsivePanels ? responsivePanels : getState().sections;
        setState({
        ...
        var isCurrentSectionActive = extensionCall('responsiveSlides', 'isCurrentSectionActive', visibleSectionIndex) || currentSection.isActive; //setting the visible section as active when manually scrolling
        ...
        if (!isCurrentSectionActive) {
          ...
          var anchorLink = extensionCall('responsiveSlides', 'getSectionAnchor', currentSection) || currentSection.anchor;
    ...
    */
    ...
    function fullpage(containerSelector, options) {
      ...
      if (getContainer()) {
        EventEmitter.emit('beforeInit'); //Loading extensions
